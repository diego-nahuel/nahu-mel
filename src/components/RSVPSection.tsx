...
const RSVPSection = () => {
  ...
  return (
    <Box sx={{ textAlign: 'center' }}>
      {/* RSVP Section with Countdown Background */}
      <Box 
        sx={{ 
      ...
      >
        <Container maxWidth="sm">
          ...
          >
            ...
            >
              Confirmar hasta el 20 de Abril
            </Typography>
      ...
      {/* Adult Only Message with original background */}
      <Box sx={{ bgcolor: '#fcf3ee', pb: 8, pt: 2 }}>
        <Container maxWidth="sm">
          <Box
            component={motion.div}
            initial={{ opacity: 0 }}
          ...
          >
            ...
            >
              Hemos decidido que este sea un evento solo para adultos. ¡Gracias por entender y ser parte de nuestro día!
            </Typography>
          </Box>
        </Container>
      </Box>
